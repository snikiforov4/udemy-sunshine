...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String getReadableDateString(long time){
        return new SimpleDateFormat("EEE MMM dd", Locale.US).format(time);
    }
...
/*
    ...
    protected void onPostExecute(String[] data) {
        ListView forecastListView = (ListView) activity.findViewById(R.id.listview_forecast);
        @SuppressWarnings("unchecked")
        ArrayAdapter<String> adapter = (ArrayAdapter) forecastListView.getAdapter();
        adapter.clear();
        adapter.addAll(data);
    }
